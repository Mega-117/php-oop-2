...
foreach($userList as $key => $singleUser){
    ...
    foreach($singleUser->getCart() as $key=> $singlePaymentMethod){
        ...
        echo "<ul>
                <li>Nome prodotto: $singlePaymentMethod[name]</li><br>
                <li>Quantità: $singlePaymentMethod[quantity]</li><br>
                <li>Descrizione: $singlePaymentMethod[desc]</li><br>
                <li>Prezzo: $singlePaymentMethod[price]</li><br> 
            </ul>";
    }
    echo "</ol>";
